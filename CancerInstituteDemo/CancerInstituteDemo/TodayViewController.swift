...
class TodayViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableData = [mEventData(eventName: "Spiritual Self Care — Quiet Room" , eventDetails: "Spiritual Self Care is a chaplain-led group held in the Quiet Room. Sessions include reflection on spiritual health and wellness, tools for spiritual-emotional resilience/coping and care planning. Sessions are also available in-clinic, inpatient or by phone. For inquiries, contact Annette Olsen, Chaplain, at 919.684.2843 or email at annette.olsen@duke.edu. ", eventImage: "writing.jpg"), mEventData(eventName: "Open Meditation —Quiet Room", eventDetails: "Facilitated drop-in sessions are open to persons of diverse religious and philosophical beliefs. All experience levels are welcome. Sessions include an introduction to a technique, practice period and closing. For more information or inquires, call Annette Olsen, Chaplain, at 919.684.2843 or email at annette.olsen@duke.edu. ", eventImage: "writing.jpg"), mEventData(eventName: "Write For You — 0 Level Conf. Room", eventDetails: "Discover how journaling can help you express emotions and thoughts, reduce anxiety, promote healthy creativity and help organize your life. Hosted by Arts & Health at Duke, participants receive complimentary journals, poetry packets and more. Write For You is held in the Level 0 Conference Room. Drop-ins are welcome. For more information, call 919.613.6601 or email katja.hill@duke.edu.", eventImage: "writing.jpg"), mEventData (eventName: "Tai Chi — Quiet Room", eventDetails: "Tai Chi is a holistic health practice that brings the mind and body together with slow, graceful, flowing movements performed in a meditative manner. Tai Chi is held in the Quiet Room. Registration is not required. Drop-ins are welcome. For more information, email kristy.everette@duke.edu.", eventImage: "writing.jpg")]
